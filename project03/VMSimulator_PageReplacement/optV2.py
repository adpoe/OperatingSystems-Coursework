...
# NOTES:  Got 999898 page faults on 999999 memory accesses... not good. Maybe we should index by has table,
#         instead of iteration, AND check logic
class Opt():
    ...
    """ Seems like too many page faults, double check this logic """
